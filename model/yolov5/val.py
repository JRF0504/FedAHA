...
from model.yolov5.utils.general import coco80_to_coco91_class, check_dataset, check_img_size, check_requirements, \
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default = 'model/yolov5/data/NWPU.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='pt/FedAvg_NU_10_1.pt', help='model.pt path(s)')
