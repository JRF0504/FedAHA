...
def run(
    ...
    if training:  # called by train.py
        ...
        model = DetectMultiBackend(model,weights, device=device, dnn=dnn, data=data, fp16=half)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/exp2/weights/model_client_0_epoch_299.pt', help='model.pt path(s)')
    parser.add_argument('--cfg', type=str, default=ROOT /'models/yolov5s.yaml', help='model.yaml path')
    parser.add_argument('--hyp', type=str, default= 'config/hyps/hyp.scratch.yaml', help='hyperparameters path')
